...
class Train_Car extends Base_Entity {
    ...
    */
    ...
    Set_Car_Walls_And_Doors_Initial_Positions() {
        ...
        this.Walls_And_Doors.Top_Left_Door.setXYWH(TLD.x, TLD.y, TLD.width, TLD.height);
        const TRD = {
        ...
        this.Walls_And_Doors.Top_Right_Door.setXYWH(TRD.x, TRD.y, TRD.width, TRD.height);
        const TRW = {
        ...
        this.Walls_And_Doors.Top_Right_Wall.setXYWH(TRW.x, TRW.y, TRW.width, TRW.height);
        // now bot side
        ...
        this.Walls_And_Doors.Bottom_Left_Wall.setXYWH(BLW.x, BLW.y, BLW.width, BLW.height);
        const BLD = {
            x: carX + Offset_To_The_Right_Of_One_Wall_Or_Door,
            y: Bottom_Entities_Y,
            width: Top_And_Bottom_Entity_Width,
        ...
        this.Walls_And_Doors.Bottom_Left_Door.setXYWH(BLD.x, BLD.y, BLD.width, BLD.height);
        const BRD = {
            x: carX + Offset_To_The_Right_Of_One_Wall_Or_Door + Offset_To_The_Right_Of_One_Wall_Or_Door,
            y: Bottom_Entities_Y,
            width: Top_And_Bottom_Entity_Width,
        ...
        this.Walls_And_Doors.Bottom_Right_Door.setXYWH(BRD.x, BRD.y, BRD.width, BRD.height);
        const BRW = {
            x: carX + Offset_To_The_Right_Of_One_Wall_Or_Door + Offset_To_The_Right_Of_One_Wall_Or_Door + Offset_To_The_Right_Of_One_Wall_Or_Door,
            y: Bottom_Entities_Y,
            width: Top_And_Bottom_Entity_Width,
