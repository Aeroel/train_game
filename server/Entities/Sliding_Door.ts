...
import { Sensor } from "#root/Entities/Sensor.ts"
...
class Sliding_Door extends Base_Entity {
    ...
    Which_Direction_The_Door_Slides_When_Closing;
    sensors ={
   ...
   Door_Sliding_Speed = 10;
    ...
    constructor(Sliding_Open_Direction) {
        ...
        this.Which_Direction_The_Door_Slides_When_Closing = Entity_Forces.Get_Opposite_Force(this.Which_Direction_The_Door_Slides_When_Opening);
    }
    updateState() {
